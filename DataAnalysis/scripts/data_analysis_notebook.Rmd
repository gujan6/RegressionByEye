...
This script provides all manipulations for the Eclipse project
...
```{r}
# check the validation stimuli and delete those participants whose average error exceedes 0.2
...
```{r}
plot_graphs(orig_results, "Visualization of the original data")
```

Visualize our data:
```{r}
plot_graphs(our_results, "Visualization of our data")
```
